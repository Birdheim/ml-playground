...
function Experiment() {
    ...
    return (
        <main className="experiment-main">
            ...
            {/* Every stage is a different height — swapping the guess for the
                result moved the footer 205px in one frame. The column grows
                and shrinks into the new size instead. */}
            <AutoHeight>
